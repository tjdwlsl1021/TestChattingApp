...
import com.example.testchattingapp.databinding.ActivityMessageBinding
import com.example.testchattingapp.model.ChatModel
import com.example.testchattingapp.model.Friend
...
class MessageActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.messageActivityImageView.setOnClickListener {
            ...
            val comment =
                ChatModel.Comment(uid, binding.messageActivityEditText.text.toString(), curTime)
            if (chatRoomUid == null) {
